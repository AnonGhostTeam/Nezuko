...
## How to Run:
> `git clone https://github.com/AnonGhostTeam/Nezuko.git`
...
## Notes:
- This tool will consume a lot of disk usage, so don't forget to housekeep `nezuko-tempdata` and` scan-logs`.
